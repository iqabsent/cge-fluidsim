...
@class AudioQueueServicesController;
...
@interface BBSceneController : NSObject <EWSoundCallbackDelegate> {
	...
	AudioQueueServicesController* audioQueueBackgroundMusic;
}
...
@property (nonatomic, retain) AudioQueueServicesController* audioQueueBackgroundMusic;
