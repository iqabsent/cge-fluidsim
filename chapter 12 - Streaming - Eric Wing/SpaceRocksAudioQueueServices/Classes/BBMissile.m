...
+ (void) loadResources
{
	[[OpenALSoundController sharedSoundController] soundBufferDataFromFileBaseName:LASER1];
}
...
- (void) playSound
{
	self.soundSourceObject.rolloffFactor = 5.0;
	self.soundSourceObject.referenceDistance = 50.0;

	[self.soundSourceObject playSound:[[OpenALSoundController sharedSoundController] soundBufferDataFromFileBaseName:LASER1]];	
}
