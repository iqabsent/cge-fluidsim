...
+ (void) loadResources
{
	[[OpenALSoundController sharedSoundController] soundBufferDataFromFileBaseName:EXPLOSION1];
	[[OpenALSoundController sharedSoundController] soundBufferDataFromFileBaseName:EXPLOSION2];
}
...
-(void)awake
{
	...
	self.soundSourceObject.rolloffFactor = 1.0;
...
//	[[BBSceneController sharedSceneController] removeObjectFromScene:self];
	...
	if (smashCount >= 2)
	{
		[self.soundSourceObject playSound:[[OpenALSoundController sharedSoundController] soundBufferDataFromFileBaseName:EXPLOSION1]];
		return;
	}
	...
	[self.soundSourceObject playSound:[[OpenALSoundController sharedSoundController] soundBufferDataFromFileBaseName:EXPLOSION2]];
}
