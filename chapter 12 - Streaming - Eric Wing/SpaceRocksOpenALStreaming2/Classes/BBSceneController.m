...
-(void)gameOver
{
	// Let's minimize the chance of a new UFO being created while our taunt UFO is around by resetting the counter.
	// It won't affect any UFO already in the scene.
